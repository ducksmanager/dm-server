...
class EdgePhotoSent extends AbstractEmail {
    ...
    public function getSubject() : string {
        return "Edge photo sent : {$this->getIssueCode()}";
    }
    ...
    public function __toString() : string {
        return "user {$this->user->getUsername()} sent the photo of edge {$this->getIssueCode()}";
    }
